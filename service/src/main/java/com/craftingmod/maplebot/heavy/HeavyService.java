...
import com.craftingmod.maplebot.heavy.modules.Sync;
...
public class HeavyService extends Service implements IServiceHeavy {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        Intent aIntent = new Intent(this.getContext(), AlarmReceiver.class);
    ...
    private void initModules(){
        ...
        HeavyModule[] md = new HeavyModule[]{
                new UInfo(this),new Online(this),new BackDel(this),new Sync(this)
        };
        modules.clear();
